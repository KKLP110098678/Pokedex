    ...
    switch (type) {
        ...
        case 'ice':
            return `<svg width="24" height="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M245.04 257.047L125.585 325.374L6.05861 256.939L125.523 194.187L245.04 257.047Z" fill="#96D9D6"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M124.243 38.4753L248.229 99.881L245.059 233.697L127.993 175.719L124.243 38.4753Z" fill="#96D9D6"/>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M128.525 474.77L126.949 336.42L247.62 278.493L249.108 409.121L128.525 474.77Z" fill="#96D9D6"/>
            </svg>`;
...
function displayFilteredPokemon(pokemon) {
    ...
    pokemon.forEach(p => {
        pokemonContainer.innerHTML += getCardHtml(p);
    });
}
